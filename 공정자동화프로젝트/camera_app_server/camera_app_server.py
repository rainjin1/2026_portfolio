...
def camera_loop():
    ...
    window_name = "ABB Camera App Server"
    ...
    while True:
        ...
        if roi_rect is None:
            ...
            if roi_img.size > 0:
                ...
                # 수동모드가 아니고, 실행중이며, 비상정지가 아닐 때만 앱 판별값 자동 갱신
...
if __name__ == "__main__":
    print("ABB 카메라-앱 연동 서버 시작")
    print("앱 주소: http://192.168.0.72:5000/status")
